...
import { Paintbrush, Globe, Palette, Type, Image, Shield, Save, Eye } from "lucide-react";
    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Personalize a aparência, marca e domínio do seu workspace
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) => update("hideFooterBranding", v)}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              value={branding.customLoginTitle}
              onChange={(e) => update("customLoginTitle", e.target.value)}
            />
          </div>
          <div className="space-y-1.5">
            <Label className="text-sm">Subtítulo</Label>
            <Input
              value={branding.customLoginSubtitle}
              onChange={(e) => update("customLoginSubtitle", e.target.value)}
            />
          </div>
          ...
          <div className="border rounded-lg p-6 bg-muted/50">
            <div className="text-center space-y-2">
              {branding.logoUrl && (
                <img src={branding.logoUrl} alt="Logo" className="h-10 mx-auto" />
              )}
              <h3 className="text-lg font-bold" style={{ color: branding.primaryColor }}>
                {branding.customLoginTitle || "Bem-vindo"}
              </h3>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="analytics.seudominio.com"
            />
          </div>
