          ...
          <div className="max-h-[70vh] overflow-auto overscroll-contain">
            ...
            >
              ...
              <div
                ...
                style={{ gridTemplateColumns: `repeat(${data.gridCols}, 1fr)`, gridTemplateRows: `repeat(${data.gridRows}, 1fr)` }}
              >
              ...
              <div className="absolute bottom-2 right-2 z-10 flex w-max items-center gap-1 rounded bg-background/85 px-2 py-1 text-[10px] text-muted-foreground backdrop-blur-sm">
                ...
                <div className="flex gap-0.5">
                  {[0.1, 0.3, 0.5, 0.7, 0.9].map((v) => (
                    <div key={v} className="h-3 w-3 rounded-sm" style={{ backgroundColor: getHeatColor(v, 1) }} />
                  ))}
                </div>
                <span>Alto</span>
              </div>
